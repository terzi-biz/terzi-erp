...
## Заміри / структура (24.09)
- [x] Воронка замірів (колонки за статусами, перетягування)
- [x] Блок «Заміри» в картці ліда: список, додати, статус, редагування, минулі дати
- [x] Замір із календаря автоматично створює запис заміру і з'являється в картці ліда
- [ ] Лічильник замірів на плитці ліда у воронці лідів
- [ ] Налаштування: нова структура розділів і підсторінок (керування без коду)
