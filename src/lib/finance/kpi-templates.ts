    ...
    kpi_scheme: [
      {
        ...
        title: "KPI 1. Виконані заміри — 150 грн за замір",
        kpi_type: "PER_OBJECT",
        rate: 150,
        note: "Факт — кількість завершених замірів за місяць (статус «виконано»).",
      },
      {
        code: "MEASUREMENT_TO_ESTIMATE",
        title: "KPI 2. Конверсія замір → кошторис",
        kpi_type: "SCALE_PLAN",
        target: 90,
        note: "Факт — % замірів, за якими створено кошторис.",
        tiers: [
          { from: 0, bonus: 0, label: "менше 80% нормативу" },
          { from: 80, bonus: 2000, label: "80–99%" },
          { from: 100, bonus: 4000, label: "норматив виконано" },
        ],
      },
      {
        code: "MEASUREMENT_QUALITY",
        title: "KPI 3. Якість даних заміру",
        kpi_type: "CHECKLIST",
        rate: 3000,
        items: 3,
        note: "Повна картка заміру; без повторних виїздів через помилки; фото та схема додані.",
      },
      {
        code: "MEASUREMENT_SLA",
        title: "KPI 4. Швидкість реакції (замір у 48 год від заявки)",
        kpi_type: "SCALE_PLAN",
        target: 95,
        note: "Факт — % замірів, проведених у нормативний строк.",
        tiers: [
          { from: 0, bonus: 0, label: "нижче нормативу" },
          { from: 100, bonus: 3000, label: "норматив виконано" },
        ],
      },
    ],
  },
