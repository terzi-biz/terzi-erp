...
type Tab = "screed" | "grades" | "roofing" | "roofing_norms" | "insulation" | "demolition" | "common" | "requisites" | "reasons" | "finance_rules" | "payroll_bridge" | "control_center" | "access";
...
function SettingsPage() {
  ...
  const tabs: { id: Tab; label: string; icon: typeof Layers }[] = [
    ...
    { id: "control_center", label: "Конфігурація: модулі, поля, довідники", icon: Grid3x3 },
  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-5xl mx-auto">
      ...
      <div className="space-y-4">
        ...
        {tab === "control_center" && <ControlCenterAdmin canEdit={canManageAccess} />}
